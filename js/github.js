  ...
  Github = window.Github = function(options) {
    ...
    Github.User = function() {
      this.repos = function(cb) {
        _request("GET", "/user/repos?type=all&per_page=1000", null, function(err, res) {
          cb(err, res);
        });
      };
      ...
      // List user emitted events
      // -------

      this.userEvents = function(username, cb) {
        _request("GET", "/users/"+username+"/events/public", null, function(err, res) {
          cb(err, res);
        });
      };
      ...
      this.userReceivedEvents = function(username, cb) {
        _request("GET", "/users/"+username+"/received_events/public", null, function(err, res) {
          cb(err, res);
        });
      };
